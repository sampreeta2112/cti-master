...
if($mode == 'I')
{
	...
	// print_r($_POST);exit;
		...
		foreach($_POST['itm_details'] as $k=>$v)
		{
			...
			$q="INSERT INTO `plan_haz`(`exp_co`,   `loc`,  `itm_details`,  `chk_pt`,`user_id`, `date`) VALUES ('".$_POST['exp_co'][$k]."','".$_POST['loc'][$k]."','".$_POST['itm_details'][$k]."','".$_POST['chk_pt'][$k]."','".$uid."','".$_POST['date'][$k]."')";
			//echo $q;exit;
			$r = RunQry($q);
