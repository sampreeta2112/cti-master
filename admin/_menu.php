...
<body onLoad="noBack();">
	...
	<nav class="navbar navbar-inverse">
	          		     <div class="logo_holder"><a class="navbar-brand" ><br><img src="../img/project.png" width="140" height="25" alt="logo'"></a></div>
	...
	<div class="col-lg-9 col-md-1 col-sm-1 col-xs-12">
                                ...
                                <div class="header-top-menu tabl-d-n">
								 <ul class="nav navbar-nav mai-top-nav">
                                      										...
                                      										<li class="nav-item"><a href="DE_operater.php" class="nav-link">USER  ACCOUNT</a>
                                        </li>
